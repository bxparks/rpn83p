...
unitTypeNamesPoolSize equ 1687 ; size of unit type names string pool
...
unitsCount equ 170 ; number of units
unitTable:
...
unitNamesPoolSize equ 1687 ; size of unit names string pool
