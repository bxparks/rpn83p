...
unitsCount equ 104 ; number of units
unitInfoTable:
...
unitLitersPerHundredKiloMetersId equ 103
...
unitNamesCount equ 104 ; number of unit names
unitNamesPoolSize equ 651 ; size of unit names string pool
