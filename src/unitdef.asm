...
unitsCount equ 150 ; number of units
unitInfoTable:
...
unitLitersPerHundredKiloMetersId equ 149
...
unitNamesCount equ 150 ; number of unit names
unitNamesPoolSize equ 1275 ; size of unit names string pool
