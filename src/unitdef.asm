...
unitsCount equ 110 ; number of units
unitInfoTable:
...
unitLitersPerHundredKiloMetersId equ 109
...
unitNamesCount equ 110 ; number of unit names
unitNamesPoolSize equ 689 ; size of unit names string pool
