...
unitsCount equ 133 ; number of units
unitInfoTable:
...
unitLitersPerHundredKiloMetersId equ 132
...
unitNamesCount equ 133 ; number of unit names
unitNamesPoolSize equ 1057 ; size of unit names string pool
