...
unitsCount equ 126 ; number of units
unitInfoTable:
...
unitLitersPerHundredKiloMetersId equ 125
...
unitNamesCount equ 126 ; number of unit names
unitNamesPoolSize equ 839 ; size of unit names string pool
