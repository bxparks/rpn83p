...
unitsCount equ 134 ; number of units
unitInfoTable:
...
unitLitersPerHundredKiloMetersId equ 133
...
unitNamesCount equ 134 ; number of unit names
unitNamesPoolSize equ 1066 ; size of unit names string pool
