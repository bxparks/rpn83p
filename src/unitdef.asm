...
unitsCount equ 115 ; number of units
unitInfoTable:
...
unitLitersPerHundredKiloMetersId equ 114
...
unitNamesCount equ 115 ; number of unit names
unitNamesPoolSize equ 748 ; size of unit names string pool
