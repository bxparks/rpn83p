...
unitsCount equ 117 ; number of units
unitInfoTable:
...
unitLitersPerHundredKiloMetersId equ 116
...
unitNamesCount equ 117 ; number of unit names
unitNamesPoolSize equ 770 ; size of unit names string pool
