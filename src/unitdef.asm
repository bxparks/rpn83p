...
unitsCount equ 111 ; number of units
unitInfoTable:
...
unitLitersPerHundredKiloMetersId equ 110
...
unitNamesCount equ 111 ; number of unit names
unitNamesPoolSize equ 699 ; size of unit names string pool
