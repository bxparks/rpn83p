...
unitsCount equ 139 ; number of units
unitInfoTable:
...
unitLitersPerHundredKiloMetersId equ 138
...
unitNamesCount equ 139 ; number of unit names
unitNamesPoolSize equ 1132 ; size of unit names string pool
