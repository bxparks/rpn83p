...
unitsCount equ 149 ; number of units
unitInfoTable:
...
unitLitersPerHundredKiloMetersId equ 148
...
unitNamesCount equ 149 ; number of unit names
unitNamesPoolSize equ 1244 ; size of unit names string pool
