...
unitsCount equ 136 ; number of units
unitInfoTable:
...
unitLitersPerHundredKiloMetersId equ 135
...
unitNamesCount equ 136 ; number of unit names
unitNamesPoolSize equ 1097 ; size of unit names string pool
