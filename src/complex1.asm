...
; Output: OP3/OP4
; Destroys: A
convertOp3ToCp3PageOne:
    call checkOp3ComplexPageOne ; ZF=1 if complex
    ret z
    call checkOp3RealPageOne
    jr nz, convertErrPageOne
    call op4Set0PageOne
