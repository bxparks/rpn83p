...
mDateId equ 16
    ...
    .db 3 ; numRows
    .db mLeapYearId ; rowBeginId or altNameId
    .dw mGroupHandler ; handler (predefined)
    .dw 0 ; nameSelector
...
mDateLikeToEpochSecondsId equ 217
    .db mDateLikeToEpochSecondsId ; id
    .db mDateId ; parentId
    .db mDateLikeToEpochSecondsNameId ; nameId
    .db 0 ; numRows
    .db 0 ; rowBeginId or altNameId
...
mEpochSecondstoDateId equ 219
    .db mEpochSecondstoDateId ; id
    .db mDateId ; parentId
    .db mEpochSecondstoDateNameId ; nameId
    .db 0 ; numRows
    .db 0 ; rowBeginId or altNameId
...
mEpochSecondstoOffsetDateTimeId equ 221
    .db mEpochSecondstoOffsetDateTimeId ; id
    .db mDateId ; parentId
    .db mEpochSecondstoOffsetDateTimeNameId ; nameId
    .db 0 ; numRows
    .db 0 ; rowBeginId or altNameId
...
mEpochId equ 222
    ...
    .db 2 ; numRows
    .db mEpochCustomId ; rowBeginId or altNameId
    .dw mGroupHandler ; handler (predefined)
    .dw 0 ; nameSelector
mTimeZone:
mTimeZoneId equ 223
...
mEpochTiosId equ 231
    .db mEpochTiosId ; id
    .db mEpochId ; parentId
    .db mEpochTiosNameId ; nameId
    .db 0 ; numRows
    .db mEpochTiosAltNameId ; rowBeginId or altNameId
...
mTodayId equ 243
    .db mTodayId ; id
    .db mRtcId ; parentId
    .db mTodayNameId ; nameId
    .db 0 ; numRows
    .db 0 ; rowBeginId or altNameId
    .dw mTodayHandler ; handler (to be implemented)
    .dw 0 ; nameSelector
mSetClock:
mSetClockId equ 244
    .db mSetClockId ; id
    .db mRtcId ; parentId
    .db mSetClockNameId ; nameId
    .db 0 ; numRows
    .db 0 ; rowBeginId or altNameId
    .dw mSetClockHandler ; handler (to be implemented)
    .dw 0 ; nameSelector
mSetClockTimeZone:
mSetClockTimeZoneId equ 245
    .db mSetClockTimeZoneId ; id
    .db mRtcId ; parentId
    .db mSetClockTimeZoneNameId ; nameId
    .db 0 ; numRows
    .db 0 ; rowBeginId or altNameId
    .dw mSetClockTimeZoneHandler ; handler (to be implemented)
    .dw 0 ; nameSelector
mGetClockTimeZone:
mGetClockTimeZoneId equ 246
    .db mGetClockTimeZoneId ; id
    .db mRtcId ; parentId
    .db mGetClockTimeZoneNameId ; nameId
    .db 0 ; numRows
    .db 0 ; rowBeginId or altNameId
...
mNowNameId equ 236
    .dw mNowName
mTodayNameId equ 237
    .dw mTodayName
mSetClockNameId equ 238
    .dw mSetClockName
mSetClockTimeZoneNameId equ 239
    .dw mSetClockTimeZoneName
mGetClockTimeZoneNameId equ 240
