...
- `ROOT` > `MATH` ![ROOT > MATH](images/menu-root-math.png)
...
- `ROOT` > `NUM` ![ROOT > NUM](images/menu-root-num.png)
...
- `ROOT` > `PROB` ![ROOT > PROB](images/menu-root-prob.png)
...
- `ROOT` > `CPLX` ![ROOT > CPLX](images/menu-root-cplx.png)
...
- `ROOT` > `BASE` ![ROOT > BASE](images/menu-root-base.png)
...
- `ROOT` > `HYP` ![ROOT > HYP](images/menu-root-hyp.png)
...
- `ROOT` > `STAT` ![ROOT > STAT](images/menu-root-stat.png)
...
- `ROOT` > `CONV` ![ROOT > CONV](images/menu-root-conv.png)
...
- `ROOT` > `TVM` ![ROOT > TVM](images/menu-root-tvm.png)
...
- `ROOT` > `CLR` ![ROOT > CLR](images/menu-root-clr.png)
    ...
    - `CLTV`: clear TVM variables and parameters
- `ROOT` > `MODE` ![ROOT > MODE](images/menu-root-mode.png)
...
- `ROOT` > `STK` ![ROOT > STK](images/menu-root-stk.png)
...
- `ROOT` > `UNIT` ![ROOT > UNIT](images/menu-root-unit.png)
...
- `ROOT` > `DATE` ![ROOT > DATE](images/menu-root-date.png)
